...
const txt='PORT=5000 node server.js';
for(let i=0;i<txt.length;i++){
  await cdp.send('Input.dispatchKeyEvent',{type:'char',text:txt[i],unmodifiedText:txt[i],key:txt[i],windowsVirtualKeyCode:txt[i].charCodeAt(0)});
