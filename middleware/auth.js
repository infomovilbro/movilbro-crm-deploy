...
var ROLE_PERMISSIONS = {
  admin: { all: true },
  comercial: { all: false, routes: ['/clientes', '/altas', '/whatsapp', '/products', '/productos', '/subscriptions', '/suscripciones', '/leads', '/kpis', '/analytics', '/analitica', '/history', '/historial', '/coverage', '/cobertura', '/email', '/correo', '/api', '/codeopen', '/fix-notes'] },
