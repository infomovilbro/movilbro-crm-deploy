  ...
  router.post('/', async (req, res) => {
    ...
    // ============================
      ...
      const temas = [
        ...
        { patron: ['como se','cómo se','cómo puedo','como puedo','como hago','cómo hago','cómo configuro','como configuro','se puede'], resp: `Dime exactamente qué necesitas hacer y te guío. Por ejemplo: "cómo creo un cliente", "cómo configuro el Gmail", "cómo hago un presupuesto".` },
