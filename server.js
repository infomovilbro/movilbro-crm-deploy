...
app.use(helmet({
  contentSecurityPolicy: {
    ...
    directives: {
      ...
      imgSrc: ["'self'", "data:", "blob:", "static.whatsapp.net", "web.whatsapp.com", "https://*.whatsapp.net", "prod-likes-customer-documents.s3.eu-central-1.amazonaws.com", "https://prod-likes-customer-documents.s3.eu-central-1.amazonaws.com"],
